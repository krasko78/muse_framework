...
void NavigationController::init()
{
    ...
    d->onRequest(this, NEXT_PANEL_COMMAND, [this]() { navigateTo(NavigationType::NextControl); return muse::make_ok(); }); // krasko
    d->onRequest(this, PREV_PANEL_COMMAND, [this]() { navigateTo(NavigationType::PrevControl); return muse::make_ok(); }); // krasko
